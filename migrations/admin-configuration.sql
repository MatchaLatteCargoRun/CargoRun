...
BEGIN TRY
  ...
  CREATE TABLE dbo.CargoRunAirlineProfiles (
    ...
    EffectiveFrom date NOT NULL,
    EffectiveTo date NULL,
    DecisionSequence int NOT NULL CONSTRAINT DF_CargoRunAirlineProfiles_DecisionSequence DEFAULT(1),
    ...
    CONSTRAINT UQ_CargoRunAirlineProfiles_Version UNIQUE(AirlineId,StationScopeKey,EffectiveFrom,DecisionSequence),
    CONSTRAINT CK_CargoRunAirlineProfiles_DecisionSequence CHECK(DecisionSequence>=1),
  ...
  CREATE TABLE dbo.CargoRunShcGroupVersions (
    ...
    EffectiveFrom date NOT NULL,
    EffectiveTo date NULL,
    DecisionSequence int NOT NULL CONSTRAINT DF_CargoRunShcGroupVersions_DecisionSequence DEFAULT(1),
    ...
    CONSTRAINT UQ_CargoRunShcGroupVersions_Version UNIQUE(ShcGroupId,EffectiveFrom,DecisionSequence),
    CONSTRAINT CK_CargoRunShcGroupVersions_DecisionSequence CHECK(DecisionSequence>=1),
  ...
  CREATE TABLE dbo.CargoRunShcGroupMappings (
    ...
    EffectiveFrom date NOT NULL,
    EffectiveTo date NULL,
    DecisionSequence int NOT NULL CONSTRAINT DF_CargoRunShcGroupMappings_DecisionSequence DEFAULT(1),
    ...
    CONSTRAINT UQ_CargoRunShcGroupMappings_Version UNIQUE(ShcId,ShcGroupId,AirlineScopeKey,StationScopeKey,EffectiveFrom,DecisionSequence),
    CONSTRAINT CK_CargoRunShcGroupMappings_DecisionSequence CHECK(DecisionSequence>=1),
  ...
  CREATE TABLE dbo.CargoRunSlaRules (
    ...
    EffectiveFrom date NOT NULL,
    EffectiveTo date NULL,
    DecisionSequence int NOT NULL CONSTRAINT DF_CargoRunSlaRules_DecisionSequence DEFAULT(1),
    ...
    CONSTRAINT UQ_CargoRunSlaRules_Version UNIQUE(RuleKey,AirlineScopeKey,StationScopeKey,EffectiveFrom,DecisionSequence),
    CONSTRAINT CK_CargoRunSlaRules_DecisionSequence CHECK(DecisionSequence>=1),
  ...
  CREATE TABLE dbo.CargoRunPriorityRules (
    ...
    EffectiveFrom date NOT NULL,
    EffectiveTo date NULL,
    DecisionSequence int NOT NULL CONSTRAINT DF_CargoRunPriorityRules_DecisionSequence DEFAULT(1),
    ...
    CONSTRAINT UQ_CargoRunPriorityRules_Version UNIQUE(ShcGroupId,AirlineScopeKey,StationScopeKey,EffectiveFrom,DecisionSequence),
    CONSTRAINT CK_CargoRunPriorityRules_DecisionSequence CHECK(DecisionSequence>=1),
  ...
  CREATE TABLE dbo.CargoRunMailRules (
    ...
    EffectiveFrom date NOT NULL,
    EffectiveTo date NULL,
    DecisionSequence int NOT NULL CONSTRAINT DF_CargoRunMailRules_DecisionSequence DEFAULT(1),
    ...
    CONSTRAINT UQ_CargoRunMailRules_Version UNIQUE(AirlineScopeKey,StationScopeKey,EffectiveFrom,DecisionSequence),
    CONSTRAINT CK_CargoRunMailRules_DecisionSequence CHECK(DecisionSequence>=1),
